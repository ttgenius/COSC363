...
void walls()
{
	...
	////////////////////// BACK WALL ///////////////////////
		...
		glTexCoord2f(0,2); glVertex3f(-15, 2, -15);
		glTexCoord2f(0,0); glVertex3f(-15, 0, -15);
		glTexCoord2f(12, 0); glVertex3f(15, 0, -15);
		glTexCoord2f(12,2); glVertex3f(15, 2, -15);
...
void floor()
{
	...
	glBegin(GL_QUADS);
		glTexCoord2f(0,16);glVertex3f(-15, 0, -15);
		glTexCoord2f(0,0);glVertex3f(-15, 0, 15);
		glTexCoord2f(16,0);glVertex3f(15, 0, 15);
		glTexCoord2f(16,16);glVertex3f(15, 0, -15);
	glEnd();
}
